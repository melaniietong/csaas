...
const data: Record<string, Company> = {
  ...
  'skip-the-dishes': {
    ...
    subprocessors: {
      ...
      analytics: [
        {
          id: 'google',
          source: 'https://www.skipthedishes.com/privacy-policy',
          lastUpdated: '2025-02-27T00:00:00.000Z',
        },
      ],
    },
  },
  hardbacon: {
    name: 'Hardbacon',
    desc: 'Find the best rates for insurance, mortgages, loans, and credit cards in Canada. Hardbacon helps you compare quotes from top providers instantly—save more today!',
    link: 'https://hardbacon.ca/',
    hq: 'Montréal, QB',
    tagIds: [11],
    competitors: [
      'Mint',
    ...
    subprocessors: {
      cloud: [
        {
          id: 'google',
          source: 'https://hardbacon.ca/en/privacy/',
          lastUpdated: '2023-08-31T00:00:00.000Z',
        },
        {
          id: 'oneSignal',
          source: 'https://hardbacon.ca/en/privacy/',
  ...
  clearco: {
    name: 'Clearco',
    desc: 'Get fast, flexible, non-dilutive funding to scale your ecommerce or SaaS brand. Clearco has invested $3B+ into 10,000+ businesses. Access capital for inventory, ads, invoices, and growth, decisions in as little as 24 hours.',
    link: 'https://www.clear.co/',
    hq: 'Toronto, ON',
    tagIds: [11],
    competitors: [
      'Shopify Capital',
  ...
  payfacto: {
    name: 'PayFacto',
    desc: 'PayFacto provides industry-leading payment processing technologies and flexible solutions to help merchants, ISOs and ISVs meet market needs. Learn more now!',
    link: 'https://payfacto.com/',
    hq: 'Montréal, QB',
    tagIds: [2, 11],
    competitors: [
      'Square',
  ...
  finhaven: {
    name: 'Finhaven',
    desc: 'A unified approach to manage business operations and relationships',
    link: 'https://www.finhaven.com/',
    hq: 'Vancouver, BC',
    tagIds: [11],
    competitors: [
      'Securitize',
  ...
  bitbuy: {
    name: 'Bitbuy',
    desc: 'Join the Leading Regulated Cryptocurrency Marketplace in Canada. Low fees & top security at Bitbuy® when you buy Bitcoin, Ethereum & more. Start trading today!',
  ...
  'helpseeker-technologies': {
    ...
    desc: 'HelpSeeker Technologies offers data-driven social solutions, tools, and resources to address homelessness, mental health, community safety, and more. Discover community support solutions today.',
    link: 'https://www.helpseeker.org/',
    hq: 'Calgary, AB',
    tagIds: [25],
    competitors: [
      ...
      'NowPow',
      'Findhelp',
      '211 / United Way Platforms',
      'SocialServe',
      'ServicePoint (WellSky)',
      'Apricot (Bonterra)',
      'CharityTracker',
      'CaseWorthy',
      'ETO Software (Bonterra)',
      ...
      'Clear Impact',
      'Results Scorecard',
      'WellSky Social Services',
      'VisionLink',
      'Link2Feed',
      'Infoxchange',
      'Ask Izzy',
      'Beneficiary Outreach Platforms',
      'mRelief',
    ],
    subprocessors: {
      cloud: [],
      ...
      analytics: [
        {
          id: 'google',
          source: 'https://www.helpseeker.org/privacy-policy',
          lastUpdated: '2024-04-24T00:00:00.000Z',
        },
        {
          id: 'twitter',
          source: 'https://www.helpseeker.org/privacy-policy',
